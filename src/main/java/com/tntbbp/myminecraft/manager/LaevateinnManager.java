    ...
    public ItemStack createItem() {
        ...
        ItemStack item = new ItemBuilder(Material.NETHERITE_SWORD)
                ...
                .lore(List.of(
                        ...
                        "",
                        "§8▪ §7기본",
                        "§8  ┗ §7공격력 §c" + formatNumber(attackDamage),
                        "§8  ┗ §7공격속도 §e1.6",
                        "",
                        "§8▪ §7스킬",
                        "§8  ┗ §6[F] §f라그나로크의 숨결 §7(재사용 " + abilityCooldownSeconds() + "초)",
                        "§8     §7전방에 거대한 화염을 내뿜어",
                        "§8     §7광역 피해 + 띄우기 + 화상을 입히고,",
                        "§8     §7땅을 일시적으로 마그마로 바꿉니다.",
                        "§8  ┗ §c영원한 불꽃 §7(공격 적중 시)",
                        "§8     §7오직 다량의 물로만 꺼지는",
                        "§8     §7마법의 불꽃이 옮겨붙습니다.",
                        "§8  ┗ §c지옥의 화상 §7(공격 적중 시)",
                        "§8     §7방어력을 무시하는 지속 피해를 주며,",
                        "§8     §7불타는 동안 치유 효과가 감소합니다.",
                        "",
